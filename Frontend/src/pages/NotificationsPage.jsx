...
const NotificationsPage = () => {
  ...
  const { mutate: rejectRequestMutation, isPending: rejectIsPending } =
    useMutation({
  ...
  const acceptedRequests = FriendRequests?.acceptRequest || []; // Fixed property name
                      ...
                      <div className="card-body p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="w-40 flex justify-between">
                            ...
                            <button
                              className="btn btn-primary bg-red-500 hover:bg-red-700 btn-sm"
